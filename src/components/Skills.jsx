...
const categoryColorMap = {
  'Languages': { bg: 'rgba(42,125,225,0.12)', text: '#5A9DEF' },
  'Frontend': { bg: 'rgba(56,189,248,0.12)', text: '#38BDF8' },
  'Backend': { bg: 'rgba(139,92,246,0.12)', text: '#A78BFA' },
  'Database': { bg: 'rgba(16,185,129,0.12)', text: '#34D399' },
  'Infrastructure & Tools': { bg: 'rgba(251,146,60,0.12)', text: '#FB923C' },
  'Analytics': { bg: 'rgba(236,72,153,0.12)', text: '#F472B6' },
  'AI-Assisted Development': { bg: 'rgba(168,85,247,0.12)', text: '#C084FC' },
}
...
function getPillColor(groupName, skillName) {
  ...
  return {
    ...
    color: isPrimary ? base.text : 'var(--text-muted)',
